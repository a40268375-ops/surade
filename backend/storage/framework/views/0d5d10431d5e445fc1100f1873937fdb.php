                ...
                <table width="480" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;">
                    ...
                    <tr>
                        <td style="padding:32px;">
                            <p style="font-size:16px;color:#111827;margin:0 0 16px;">Halo <?php echo e($userName); ?>,</p>
                    ...
                    <tr>
                        <td style="padding:16px 32px;background:#f9fafb;">
                            <span style="font-size:12px;color:#9ca3af;">&copy; <?php echo e(date('Y')); ?> Surade.co.id</span>
                        </td>
                    </tr>
                </table>
            </td>
...
</html><?php /**PATH C:\Users\a4026\Documents\surade\backend\resources\views/emails/reset-password-code.blade.php ENDPATH**/ ?>